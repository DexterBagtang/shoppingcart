                            ...
                            {{csrf_field()}}
                                <div class="card-body">
                                    <div class="form-group">
                                        {{Form::label('','Slider Description One',['for'=>'exampleInputEmail1'])}}
                                        {{Form::text('description1','',['class'=>'form-control','id'=>'exampleInputEmail1',
...
{{--                                    --}}
                                    ...
                                    <div class="form-group">
                                        {{Form::label('','Slider Description Two',['for'=>'exampleInputEmail1'])}}
                                        {{Form::text('description2','',['class'=>'form-control','id'=>'exampleInputEmail1',
                                                'placeholder'=>'Enter slider description'])}}
                                    </div>
                                    <label for="exampleInputFile">Slider image</label>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            {{Form::file('sliderimage',['class'=>'custom-file-input','id'=>'exampleInputFile'])}}
