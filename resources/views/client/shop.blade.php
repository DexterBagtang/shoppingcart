            ...
            <div class="col-md-10 mb-5 text-center">
                ...
                <ul class="product-category">
                    ...
                    @foreach($categories as $category)
                        <li><a href="{{url('/viewproductcategory/'.$category->category_name)}}" class="{{request()->is('viewproductcategory/'.$category->category_name) ? 'active' : ''}}">{{$category->category_name}}</a></li>
{{--                    --}}
                ...
                <div class="product">
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="bottom-area d-flex px-3">
                            <div class="m-auto d-flex" title="Add to Cart">
