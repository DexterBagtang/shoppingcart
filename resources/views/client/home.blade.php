...
<section id="home-section" class="hero">
    <div class="home-slider owl-carousel">
        ...
        @foreach($sliders as $slider)
            <div class="slider-item" style="background-image: url({{asset('storage/slider_images/'.$slider->sliderimage)}});">
        ...
        <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{asset('frontend/images/category-1.jpg')}});">
                            <div class="text px-3 py-1">
                                <h2 class="mb-0"><a href="{{url('/viewproductcategory/Fruits')}}">Fruits</a></h2>
                            </div>
                        </div>
                        <div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url({{asset('frontend/images/category-2.jpg')}});">
                            <div class="text px-3 py-1">
                                <h2 class="mb-0"><a href="{{url('/viewproductcategory/Vegetables')}}">Vegetables</a></h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="category-wrap ftco-animate img mb-4 d-flex align-items-end" style="background-image: url({{asset('frontend/images/category-3.jpg')}});">
                    <div class="text px-3 py-1">
                        <h2 class="mb-0"><a href="{{url('/viewproductcategory/Juices')}}">Juices</a></h2>
                    </div>
                </div>
                <div class="category-wrap ftco-animate img d-flex align-items-end" style="background-image: url({{asset('frontend/images/category-4.jpg')}});">
                    <div class="text px-3 py-1">
                        <h2 class="mb-0"><a href="{{url('/viewproductcategory/Dried')}}">Dried</a></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="product">
                    ...
                    <div class="text py-3 pb-4 px-3 text-center">
                        ...
                        <div class="d-flex">
                            <div class="pricing">
                                <p class="price"><span class="mr-2 price-dc">${{$product->product_price*.30}}</span><span class="price-sale">$80.00</span></p>
                            </div>
                        </div>
